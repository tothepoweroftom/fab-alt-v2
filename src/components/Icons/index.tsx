...
function LightBulb(props: SvgIconProps) {
  return (
    <SvgIcon viewBox={"0 0 67 67"} style={{ fontSize: 70 }}>
      <path
...
function WhatIfIcon(props: SvgIconProps) {
  return (
    <SvgIcon
      {...props}
      viewBox={"0 0 67 67"}
      style={{ fontSize: 45 + window.innerWidth * 0.03 }}
    >
      <path
  ...
  return (
    ...
    >
      <path
        ...
        fill="#FF5131"
      />
      <path d="M 24 29 L 38 29 L 38 43 L 24 43 Z" fill="hsl(9, 100%, 71%)" />
  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="67" height="67">
        ...
        <path
          d="M 32.5 26.269 C 36.09 26.269 39 29.179 39 32.769 C 39 34.634 38.215 36.315 36.958 37.5 L 37 37.5 L 34 41.5 L 31 41.5 L 28 37.5 L 28.042 37.5 C 26.785 36.315 26 34.634 26 32.769 C 26 29.179 28.91 26.269 32.5 26.269 Z"
          fill="rgba(223, 223, 119, 1.00)"
        />
        <path
