...
export class LottieAnim extends React.Component<Partial<Props>> {
  static defaultProps = {
    ...
    if (error) {
      return (
        <div style={styleError}>
          Error loading URL, please check the URL is a valid Lottie JSON URL
        </div>
      );
    }
    if (!animationData) {
